...
// Recharger les versions depuis la DB pour avoir les questions
...
// Générer les PDFs et les zipper en mémoire
                            ...
                            <tr>
                                <td style="padding:40px;">
                                    ...
                                    <p style="color:#94a3b8;font-size:14px;line-height:1.7;margin:0 0 24px;">
                                        Vous avez été invité(e) à passer le quiz suivant.
                                    </p>
                                    <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#0f172a;border-radius:12px;border:1px solid #334155;margin-bottom:32px;">
                                        <tr>
                                            <td style="padding:20px 24px;">
                                                <p style="margin:0 0 4px;color:#64748b;font-size:11px;text-transform:uppercase;">Quiz</p>
                                                <p style="margin:0 0 16px;color:#f1f5f9;font-size:18px;font-weight:700;">{$qcm->getTitle()}</p>
                                                <p style="margin:0 0 4px;color:#64748b;font-size:11px;text-transform:uppercase;">Matière</p>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                <a href="{$link}"
                                                   style="display:inline-block;background:linear-gradient(135deg,#4f46e5,#6366f1);color:#ffffff;text-decoration:none;padding:16px 48px;border-radius:12px;font-size:15px;font-weight:600;">
                                                    Accéder à mon quiz →
                                                </a>
                                            </td>
                                        </tr>
