 ...
 */
final class Version20260318101541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE qcm_version (id INT AUTO_INCREMENT NOT NULL, version_number INT NOT NULL, public_id VARCHAR(36) NOT NULL, shuffle_seed INT NOT NULL, created_at DATETIME NOT NULL, qcm_id INT NOT NULL, INDEX IDX_6DA10888FF6241A6 (qcm_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
